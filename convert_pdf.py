...
# 引入每日数据对比 (Daily Comparison & Delta Tracking) 视效引擎
css = """
@page {
    size: A4;
...
/* 每日数据对比与变动趋势 (Daily Comparison Delta) 专用卡片 */
.compare-card {
...
<div class="container">
  ...
  <div class="header-hero">
    ...
    <div class="header-meta">
      <span>⏱️ 实时对比更新：2026-07-23 09:09 (每日自动比对引擎已激活)</span>
      <span>🛡️ 官方数据源：甘孜州气象局 / 甘孜交警支队 / 四川路网 12328</span>
      <span>📊 特色：包含【今日 (7.23) vs 昨日 (7.22)】气温与路况动态 Delta 比对</span>
    </div>
  </div>

  <!-- 每日数据对比与变动趋势面板 (Daily Delta Comparison Panel) -->
  <div class="compare-card">
    <div class="compare-title">📊 全线核心节点每日动态比对 (7月23日 今日 vs 7月22日 昨日)</div>
    <div class="compare-grid">
      <div class="compare-item">
        <div class="compare-item-label">康定市气温比对</div>
        <div class="compare-item-val">9~25℃ <span class="delta-up">🔼 升温 2℃</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">折多山垭口天气比对</div>
        <div class="compare-item-val">13~22℃ 阵雨 <span class="delta-same">🟢 比昨日风力减小</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">理塘县城气温比对</div>
        <div class="compare-item-val">5~20℃ <span class="delta-down">🔽 夜间降温 3℃</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">巴塘县城气温比对</div>
        <div class="compare-item-val">15~30℃ <span class="delta-up">🔼 河谷升温 2℃</span></div>
      </div>
      <div class="compare-item">
      ...
      <div class="compare-item">
        ...
        <div class="compare-item-val">08:00-12:00 封闭 <span class="delta-same">🟢 时间窗口无变化</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <!-- 每日数据对比 -->
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.23) 比对追踪：</div>
        康定白天气温较昨日升温 2℃ (14~22℃)，阴雨减弱转为多云，适合第一晚低海拔高原适应。
      </div>
      <!-- 内嵌本日专属注意事项 -->
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.23) 比对追踪：</div>
        折多山垭口今日风力较昨日有所减缓，但午后阵雨概率仍维持在 65%，维持黄色预警级别。
      </div>
      <!-- 内嵌本日专属注意事项 -->
      <div class="notice-block">
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.23) 比对追踪：</div>
        理塘与巴塘段天气稳定，较昨日无突发降水，G318 整体通行状况良好。
      </div>
      <!-- 内嵌本日专属注意事项 -->
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box" style="background:#fef2f2; border-color:#fecaca; color:#b91c1c; border-left-color:#ef4444;">
        <div class="delta-box-title">🔄 今日 (7.23) 比对追踪：</div>
        扎瓦拉垭口今日气温 2~8℃，降水概率由昨日 80% 降至 50%，但非铺装路面仍积水陷车风险高，维持红灯警告。
      </div>
      <!-- 内嵌本日专属注意事项 -->
      <div class="notice-block notice-danger">
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.23) 比对追踪：</div>
        S569 官方施工管制方案维持不变，午间放行窗口依旧为 12:00-14:00。
      </div>
      <div class="notice-block notice-danger">
