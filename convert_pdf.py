...
.delta-up { color: #dc2626; font-size: 11px; margin-left: 4px; }
.delta-down { color: #2563eb; font-size: 11px; margin-left: 4px; }
.delta-same { color: #16a34a; font-size: 11px; margin-left: 4px; }
...
<head>
<meta charset="utf-8">
<title>川西 8.1-8.9 秘境自驾全景路书与动态对比分析</title>
<style>""" + css + """</style>
</head>
<body>
<div class="container">
  ...
  <div class="header-hero">
    <h1>🏔️ 川西 8.1–8.9 路线·天气·路况·防汛·每日动态比对路书</h1>
    <div class="header-meta">
      <span>⏱️ 实时对比更新：2026-07-24 09:27 (每日自动比对引擎已激活)</span>
      <span>🛡️ 官方数据源：甘孜州气象局 / 甘孜交警支队 / 四川路网 12328</span>
      <span>📊 特色：包含【今日 (7.24) vs 昨日 (7.23)】气温与路况动态 Delta 比对</span>
    </div>
  </div>

  <!-- 每日数据对比与变动趋势面板 (Daily Delta Comparison Panel) -->
  <div class="compare-card">
    <div class="compare-title">📊 全线核心节点每日动态比对 (7月24日 今日 vs 7月23日 昨日)</div>
    <div class="compare-grid">
      <div class="compare-item">
        <div class="compare-item-label">康定市气温比对</div>
        <div class="compare-item-val">10~24℃ <span class="delta-same">🟢 较昨日维持稳定</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">折多山垭口天气比对</div>
        <div class="compare-item-val">12~21℃ 小雨大雾 <span class="delta-down">🟡 山顶湿度增大需防大雾</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">理塘县城气温比对</div>
        <div class="compare-item-val">6~19℃ 多云转晴 <span class="delta-up">🔼 较昨日转晴适合出行</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">巴塘县城气温比对</div>
        <div class="compare-item-val">16~29℃ <span class="delta-same">🟢 维持河谷偏热状态</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">G318 全线路况比对</div>
        <div class="compare-item-val">双向畅通 <span class="delta-same">🟢 维持畅通绿灯</span></div>
      </div>
      <div class="compare-item">
        <div class="compare-item-label">S569 管制状态比对</div>
        <div class="compare-item-val">08:00-12:00 封闭 <span class="delta-same">🟢 12:00-14:00 放行窗口维持</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="section-title">📅 8.1 – 8.9 逐日精细行程·气象·路况·【本日注意事项与每日比对】全景卡片</div>
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.24) 比对追踪：</div>
        康定白天气温维持在 10~24℃，多云有阵雨，整体路况畅通，适合第一晚低海拔适应。
      </div>
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.24) 比对追踪：</div>
        折多山垭口今日湿度大有大雾小雨，降水概率仍维持在 65%，驾驶需开雾灯防滑。
      </div>
      <div class="notice-block">
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box" style="background:#fef2f2; border-color:#fecaca; color:#b91c1c; border-left-color:#ef4444;">
        <div class="delta-box-title">🔄 今日 (7.24) 比对追踪：</div>
        扎瓦拉与夯达营地非铺装路段积水较多，陷车风险高，保持红灯警告。
      </div>
      <div class="notice-block notice-danger">
        <div class="block-title">🚨 8.4 本日核心注意事项 (环保红线与安全熔断)</div>
        <ul>
          <li><strong>⚖️ 2026 环保执法红线：</strong>严禁车辆开离路基碾压草甸！在格聂之眼、夯达营地等区域，**违法将车辆开下路基碾压草滩将被处以 5万~20万元 行政重罚**！车辆必须行驶于既有路基上。</li>
  ...
  <div class="day-card">
    ...
    <div class="day-grid">
      ...
      <div class="delta-box">
        <div class="delta-box-title">🔄 今日 (7.24) 比对追踪：</div>
        S569 官方施工管制方案稳定，放行窗口维持 12:00-14:00。
      </div>
      <div class="notice-block notice-danger">
        <div class="block-title">🚨 8.7 本日核心注意事项 (S569 管制与冷嘎措防寒)</div>
        <ul>
          <li><strong>🚧 S569 修路管制破局：</strong>K16-K54 段 <code>08:00-12:00</code> 及 <code>14:00-19:00</code> 全封闭。方案1(推荐)：早晨 10:30 从新都桥出发，**卡准 `12:00-14:00` 放行窗口通过施工段**；傍晚看完日落于 `19:00 以后` 夜间窗口返回。方案2：沿 G248 国道经沙德镇绕行（车程多40分钟）。</li>
          <li>冷嘎措山顶 (4500m) 傍晚等待贡嘎雪山倒影与日照金山时寒风刺骨，必须携带薄羽绒服、防风帽与手套。</li>
...
if result.returncode == 0:
    print(f"动态比对版 PDF 生成成功: {pdf_path}")
