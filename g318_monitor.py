...
def fetch_30min_realtime_radar():
    ...
    # 全量整合：路线+气象+干净卫生间+光影摄影+防晒高反+补给提醒数据库
    cards_database = {
        "08-01": {
            "title": "成都市 ➔ 康定市",
...
def push_auto_schedule():
    ...
    if has_status_changed(card_content):
        print("30分钟巡查：更新全量神仙级提醒卡片，立即下发微信实时推送！")
        ...
        if res.get("errcode") != 0:
            ...
            tmpl_payload = {
                ...
                "data": {
                    "first": {"value": "🌸 30分钟云端雷达·全量神仙级暖心路书推送", "color": "#1890ff"},
                    "keyword1": {"value": "甘孜州气象局/甘孜交警12328/社媒24h实测", "color": "#cf1322"},
                    "keyword2": {"value": "【全量安全守护】已完成路况/卫生间/防晒/高反/光影最新校对", "color": "#333333"},
